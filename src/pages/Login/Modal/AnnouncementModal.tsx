...
import type { Announcement } from './Models-TypeScript/Anc-types'; 
    ...
    <div className="Anc-overlay" onClick={onClose}>
      <div className="Anc-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="Anc-info-box">
           ...
           <div className="Anc-info-item">
              ...
              <div className="Anc-info-text">
                 ...
                 {/* Strictly shows input. If empty, shows nothing or a dash. */}
           ...
           <div className="Anc-info-item">
              ...
              <div className="Anc-info-text">
                 ...
                 <span className="value">{data.eventTime || "-"}</span>
              </div>
           </div>
           ...
           <div className="Anc-info-item full-width">
              ...
              <div className="Anc-info-text">
                 ...
                 <span className="value">{data.organizer || "-"}</span>
              </div>
           </div>
        </div>
        ...
        <div className="Anc-body">
           <h3>Overview</h3>
           {/* pre-wrap ensures line breaks from your input are respected */}
